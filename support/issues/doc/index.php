...
<body>
    ...
    <div aria-label="breadcrumb">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active" aria-current="Issues">Docs</li>
        </ol>
    </div>
    ...
    <main class="container">
        <div class="jumbotron mt-5" style="width: 70%; margin-left: auto; margin-right: auto;">
            <div class="mb-1">
                <h2>Documentation</h2>
                <input class="form-control" type="text" id="searchTicket" onkeyup="searchTicket()" placeholder="Search for your ticket..">
            </div>
    ...
    <nav class="nav justify-content-center align-items-center p-3 m-0 flex-column">
        ...
        <p class="nav-link p-1 m-1 text-muted">Provide feedback on the site <a target="_blank" class="link" title="Requires a GitHub account." href="https://github.com/jackgraddon/lyndenit/issues/new/choose">here
